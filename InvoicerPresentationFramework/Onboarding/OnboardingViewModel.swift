...
final class OnboardingViewModel: ObservableObject {
    ...
    init(
        saveContractorInfo: SaveContractorInfoProtocol = SaveContractorInfoFactory.make(),
        getContractorInfo: GetContractorInfoProtocol = GetContractorInfoFactory.make(),
        saveCompanyAddress: SaveCompanyAddressProtocol = SaveCompanyAddressDataFactory.make(),
        getCompanyAddress: GetCompanyAddressProtocol = GetCompanyAddressFactory.make(),
        saveBankAccount: SaveBankAccountProtocol = SaveBankAccountUseCaseFactory.make(),
        getBankAccount: GetBankAccountProtocol = GetBankAccountFactory.make(),
        saveServiceInfo: SaveServiceInfoProtocol = SaveServiceInfoFactory.make(),
        getServiceInfo: GetServiceInfoProtocol = GetServiceInfoFactory.make(),
        saveOnboardingStep: SaveOnboardingStepProtocol = SaveOnboardingStepFactory.make(),
        cacheContractorInfo: CacheContractorInfoProtocol = CacheContractorInfoFactory.make(),
        cacheCompanyAddress: CacheCompanyAddressProtocol = CacheCompanyAddressFactory.make(),
        cacheBankAccount: CacheBankAccountProtocol = CacheBankAccountFactory.make(),
        cacheServiceInfo: CacheServiceInfoProtocol = CacheServiceInfoFactory.make(),
        cleanCache: CleanCacheProtocol = CleanCacheFactory.make(),
        finishOnboarding: FinishOnboardingProtocol = FinishOnboardingFactory.make(),
    ...
    private func setUpFieldValidation() {
        ...
        $bankAccountInfo
            .mapDistinct(\.secondaryBankInfo.bankAddress)
            .sink { [weak self] in
